...
static void ui_external_level_card_draw(UIElement* e) {
    ...
    draw_text(&bigFont_fontCharset, &bigFont_sheet, text_pos, e->y+1, e->external_level_card.label.scale, e->external_level_card.label.scale, e->external_level_card.label.alignment, false, "%s", e->external_level_card.label.text);
